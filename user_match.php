...
function generateCard($transaction)
{
    ...
    $buttonDisabled = ($remainingTime > 1800) ? 'disabled' : '';
    ...
    <div class='col-12'>
        <div class='card' data-remaining-time='$remainingTime'>
            <div class='card-body'>
                ...
                <form method='post'> 
                    <p>Before 30min of this game you can join</p>
                    ...
                    <button type='button' class='nasa btn' name='activate' id='activate' onClick='handleSubmit(\"" . $transaction['team1'] . "\", \"" . $transaction['team2'] . "\", \"" . $transaction['match'] . "\")' $buttonDisabled>Join Contests</button>
                </form>
            </div>
        </div>
    </div>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-9 box2">
                    <div class="row box123">
                        ...
                        <div class="col-4" id="in-progress22">
    ...
    <script>
        ...
        function handleSubmit(team1, team2) {
            var team1Id = team1;
            var team2Id = team2;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#newTeam1 tbody').empty();
                    $('#newTeam2 tbody').empty();
        ...
        newTeam.addEventListener('drop', (e) => {
            ...
            if (document.getElementById('team11').childElementCount >= 11) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if (playerType == "player2") {
                        ...
                        let newTeam1 = document.getElementById("newTeam");
                        // console.log(todo.querySelector('tbody'));
